package com.josev001.fipe_search.repository;

import com.josev001.fipe_search.dto.ConsultaFipeDTO;
import com.josev001.fipe_search.entity.ReferenciaEntity;
...
public interface ReferenciaRepository extends JpaRepository<ReferenciaEntity, Long> {
    ...
    @Query("""
            SELECT new com.josev001.fipe_search.dto.ConsultaFipeDTO(
